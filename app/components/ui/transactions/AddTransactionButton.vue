...
<template>
  <BaseButton
    @click="toggleModal"
    class="fixed bottom-6 right-6 z-50 !h-14 !w-14 !rounded-full !p-0 flex items-center justify-center md:static md:h-12 md:w-auto md:max-w-40 md:!rounded-xl md:px-4 md:gap-2"
  >
